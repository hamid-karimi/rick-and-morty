...
const ErrorPage = () => {
    ...
    return (
        ...
        >
            <div
                className='flex flex-col mb-10 space-y-5 lg:w-1/2 lg:text-2xl font-bold text-center p-3 shadow-lg rounded-md bg-white/80 text-black'

            >
                <span>YOU ARE LOST!!!</span>
                <span>Something goes wrong</span>
                <a className='text-green-800 cursor-pointer p-2 hover:text-blue-700' href='' onClick={handleClick} > Back to Home</a>
            </div>
        </div>
    )
